...
const CarGallery = ({ images = [], title }) => {
  ...
  const fallback = ['https://images.unsplash.com/photo-1502877338535-766e1452684a?auto=format&fit=crop&w=1000&q=80'];
  ...
  return (
    <div>
      <div className="aspect-[16/10] overflow-hidden rounded-xl2 bg-gray-100 dark:bg-gray-800">
        <img src={list[active]?.url} alt={title} className="h-full w-full object-cover" />
      </div>
      {list.length > 1 && (
