...
const BookingForm = ({ car, onSubmit, isSubmitting, isAuthenticated, role }) => {
  ...
  const {
    ...
    watch,
    formState: { errors },
  } = useForm({ defaultValues: { pickupDate: '', returnDate: '', pickupLocation: car.location } });
  ...
  return (
    ...
    >
      ...
      <Button type="submit" className="w-full" size="lg" loading={isSubmitting} disabled={!car.isAvailable}>
